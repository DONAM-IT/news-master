...
?>
       ...
       <!--Dantri-->
        ...
        $biglink_dantri = "https://dantri.com.vn".$list_dantri->href;
         echo "<li class='list-group-item' style='font-size:20px;'> <a href='$biglink_dantri' onclick='doalert(this); return false;'>● ".$bigtitle_dantri."</a></li>";
       ...
       <!--Nhandan-->
       <ul class="list-group">
        <li class="list-group-item active">Những tin quan trọng nhất của<a style="color : #fff;" href="https://tuoitre.vn/" target="_blank" > Tuổi Trẻ</a></li>
        <?php
            $html_tuoitre =  file_get_html("https://tuoitre.vn/tin-moi-nhat.htm");
            $list_tuoitre = $html_tuoitre->find("a[data-linktype=newsdetail]");
            foreach ($list_tuoitre as $menu_tuoitre) {
                $title_tuoitre = $menu_tuoitre->title;
                $link_tuoitre = "https://tuoitre.vn".$menu_tuoitre->href;
                echo "<li class='list-group-item'  style='font-size:15px;'> <a href='$link_tuoitre' onclick='doalert(this); return false;'>● ".$title_tuoitre."</a></li>";
            }
            ?>
        </ul> 
       <!--end nhan dan-->
                        ...
                        error_reporting(0);
                                ...
                                switch ($host) {
                                    case 'vnexpress.net':
                                        ...
                                        $typeNew = $html->find("ul[class=breadcrumb]",0)->innertext;
